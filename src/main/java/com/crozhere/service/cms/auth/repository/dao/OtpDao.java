...
public interface OtpDao {
    ...
    OTP getById(String id) throws DataNotFoundException, OtpDAOException;
    OTP getByPhone(String phone) throws DataNotFoundException, OtpDAOException;

    void updateById(String id, OTP otp) throws DataNotFoundException, OtpDAOException;
    void updateByPhone(String phone, OTP otp) throws DataNotFoundException, OtpDAOException;

    void deleteById(String id) throws DataNotFoundException, OtpDAOException;
